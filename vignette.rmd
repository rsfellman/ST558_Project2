...
I am also curious about the distribution of the Hawaii earthquake magnitudes. I will create a density plot of the Hawaii data (colored in green) layered over all of the smaller (magnitude < 4) earthquake data to see if they follow a similar distributions. 
```{r}
#create base plot
a <- ggplot(data= earthquakes.low, aes(x = mag))
#add histogram
...
#add latitude and longitude information for the map
 d + geom_polygon(data = state, aes(x=long, y= lat, group = group), color = "black", fill = "grey") +
#add the points of the earthquakes in california
   geom_point(data = eq.california, aes(x = longitude, y = latitude, colour = mag))  +
